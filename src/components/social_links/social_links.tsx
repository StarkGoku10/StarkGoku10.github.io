...
const SocialTitle = styled.h3`
  ...
  background: linear-gradient(90deg, #01AFAF,rgb(103, 225, 247)); /* Gradient effect on text */
...
const SocialDescription = styled.p`
  ...
  .highlight {
    color: #01AFAF; /* Highlighted purple color for important words */
  }
`;
...
const SocialIcons = styled.div`
  ...
  a {
    ...
    &:hover {
      color: #01AFAF; /* Change icon color to purple on hover */
    }
  }
`;
